import * as services from './logs.service.js';
...
export const obtenerLogs = async (req, res) => {
  try {
    ...
    res.status(400).json({ error: 'Error al obtener los logs' });
  }
};
...
export const obtenerLogPorId = async (req, res) => {
  ...
  try {
    ...
    res.status(400).json({ error: 'Error al obtener el log' });
  }
};
...
export const actualizarLog = async (req, res) => {
  ...
  try {
    ...
    res.status(400).json({ error: 'Error al actualizar el log' });
  }
};
...
export const eliminarLog = async (req, res) => {
  ...
  try {
    ...
    res.status(400).json({ error: 'Error al eliminar el log' });
  }
};