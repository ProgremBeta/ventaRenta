...
console.log("Cargando servicios de ventas...");

export const obtenerVentas = async () => {
  const result = await repository.obtenerVentas();
  console.log("Ventas obtenidas:", result.rows);
...
export const obtenerVentaPorId = async (id) => {
  ...
  console.log("Venta obtenida por ID:", result.rows);
...
export const crearVenta = async (datos) => {
  ...
  console.log("Venta creada:", result.rows);
...
export const actualizarVenta = async (id, datos) => {
  ...
  console.log("Venta actualizada:", result.rows);
...
export const eliminarVenta = async (id) => {
  ...
  console.log("Venta eliminada:", result.rows);
